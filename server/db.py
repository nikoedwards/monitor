...
MIGRATIONS = [
    ...
    ("sales_metrics", "category_rank", "INTEGER"),
    ("sales_metrics", "subcategory_rank", "INTEGER"),
    ("sales_metrics", "category_name", "TEXT"),
    ("sales_metrics", "subcategory_name", "TEXT"),
    ("sales_metrics", "title", "TEXT"),
    ("sales_metrics", "image_url", "TEXT"),
    ("sales_metrics", "estimate_method", "TEXT"),
    ("sales_metrics", "estimate_confidence", "TEXT"),
    ("sales_metrics", "estimate_period_days", "REAL"),
