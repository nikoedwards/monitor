...
export const TOUCHPOINTS: TouchpointSection[] = [
  ...
  },
  {
    ...
    dimension: "marketing",
    platforms: [
      { platform: "instagram", label: "Instagram", channel: "social", dataSource: "官方账号公开内容", method: "Ensemble Data 按账号采集", requires: "需配置 ensembledata_token" },
      { platform: "tiktok", label: "TikTok", channel: "social", dataSource: "官方账号公开内容", method: "Ensemble Data 按账号采集", requires: "需配置 ensembledata_token" },
      { platform: "x", label: "X (Twitter)", channel: "social", dataSource: "官方账号公开内容", method: "Ensemble Data 按账号采集", requires: "需配置 ensembledata_token" },
