...
export const TOUCHPOINTS: TouchpointSection[] = [
  ...
  },
  {
    ...
    dimension: "marketing",
    platforms: [
      { platform: "instagram", label: "Instagram", channel: "social", dataSource: "公开账号最近帖子及互动数据", method: "无登录浏览器公开接口，每日自采", requires: "无需付费 Token；仅支持公开账号，页面风控时会显示采集状态" },
      { platform: "tiktok", label: "TikTok", channel: "social", dataSource: "公开账号最近视频及播放/互动数据", method: "公开主页 + yt-dlp 网页提取，每日自采", requires: "无需付费 Token；仅支持公开账号" },
      { platform: "x", label: "X (Twitter)", channel: "social", dataSource: "官方账号公开内容", method: "适配器待接入", requires: "未登录访问和反自动化限制严格，当前会标记暂未支持" },
      { platform: "youtube", label: "YouTube", channel: "social", dataSource: "官方频道最新视频", method: "公开 Atom feed，每日采集", requires: "无需 API key；链接需指向公开频道主页" },
      { platform: "facebook", label: "Facebook", channel: "social", dataSource: "官方主页内容", method: "适配器待接入", requires: "Graph API 权限受限，当前会标记暂未支持" },
      { platform: "linkedin", label: "LinkedIn", channel: "social", dataSource: "公司主页动态", method: "适配器待接入", requires: "官方接口权限受限，当前会标记暂未支持" },
      { platform: "pinterest", label: "Pinterest", channel: "social", dataSource: "官方账号内容", method: "适配器待接入", requires: "当前会标记暂未支持" },
    ],
  },
  {
    key: "community",
